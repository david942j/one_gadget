  ...
  describe 'from file' do
    ...
    it 'libc-2.19' do
      ...
      expect(OneGadget.gadgets(file: path, force_file: true, level: 1))
        .to eq [0x461fb, 0x46421, 0x46428, 0x4647c, 0xc1ba3, 0xc1bf2, 0xe4968, 0xe5765, 0xe5771, 0xe66bd]
    end
    ...
    it 'libc-2.31' do
      ...
      expect(OneGadget.gadgets(file: path, force_file: true,
                               level: 1)).to eq [0x51df8, 0x51e2b, 0x51e32, 0x51e39, 0x51e40, 0x51e45, 0x51e55,
                                                 0x51e5a, 0x51e5d, 0x51e62, 0x51e65, 0x84165, 0x8416c, 0x84173,
                                                 0x84176, 0x8417b, 0x84180, 0x8418c, 0x84192, 0x84199, 0x841a0,
                                                 0xe3b2e, 0xe3b31, 0xe3b34, 0xe3d23, 0xe3d26, 0xe3d88, 0xe3d92,
                                                 0xe3d99, 0xe3da0, 0xe3dd7, 0xe3de1, 0xe3de5, 0xe3ded, 0x1075e7,
                                                 0x1075f1, 0x107cea]
