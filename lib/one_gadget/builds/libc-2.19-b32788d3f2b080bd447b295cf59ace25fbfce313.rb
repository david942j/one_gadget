...
# https://gitlab.com/david942j/libcdb/blob/master/libc/libc0.1-2.19-12/lib/x86_64-kfreebsd-gnu/libc-2.19.so
# 
...
OneGadget::Gadget.add(build_id, 822573,
                      constraints: ["ebx != 0x0", "[rsp+0x70] == NULL || {[rsp+0x70], [rsp+0x78], [rsp+0x80], [rsp+0x88], ...} is a valid argv"],
                      effect: "execve(\"/bin/sh\", rsp+0x70, environ)",
                      closed_fds: ["[rsp+0x60]"])
