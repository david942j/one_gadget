...
# https://gitlab.com/david942j/libcdb/blob/master/libc/libc0.1-2.19-14/lib/i386-kfreebsd-gnu/libc-2.19.so
# 
# Intel 80386
# 
# GNU C Library (Debian GLIBC 2.19-14) stable release version 2.19, by Roland McGrath et al.
...
OneGadget::Gadget.add(build_id, 657410,
...
OneGadget::Gadget.add(build_id, 657414,
...
OneGadget::Gadget.add(build_id, 657417,
