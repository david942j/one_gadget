...
# https://gitlab.com/david942j/libcdb/blob/master/libc/libc6_2.30-0ubuntu3_i386/lib/i386-linux-gnu/libc-2.30.so
# 
# Intel 80386
# 
...
OneGadget::Gadget.add(build_id, 1343307,
                      constraints: ["ebp is the GOT address of libc", "eax == NULL"],
                      effect: "execl(\"/bin/sh\", eax)")
OneGadget::Gadget.add(build_id, 1343308,
