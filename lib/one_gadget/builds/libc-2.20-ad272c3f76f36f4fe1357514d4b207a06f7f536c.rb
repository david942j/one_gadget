...
# https://gitlab.com/david942j/libcdb/blob/master/libc/glibc-2.20-2-i686.pkg.tar/usr/lib/libc-2.20.so
# 
# Intel 80386
# 
...
OneGadget::Gadget.add(build_id, 240648,
...
OneGadget::Gadget.add(build_id, 241294,
                      ...
                      effect: "execve(\"/bin/sh\", esp+0x24, environ)")
OneGadget::Gadget.add(build_id, 241295,
...
OneGadget::Gadget.add(build_id, 241301,
                      ...
                      effect: "execve(\"/bin/sh\", esp+0x28, environ)")
OneGadget::Gadget.add(build_id, 241303,
...
OneGadget::Gadget.add(build_id, 241304,
...
OneGadget::Gadget.add(build_id, 241311,
                      ...
                      effect: "execve(\"/bin/sh\", esp+0x34, environ)")
OneGadget::Gadget.add(build_id, 241317,
...
OneGadget::Gadget.add(build_id, 241320,
                      constraints: ["ebx is the GOT address of libc", "[esp+0xc] == NULL", "eax == NULL", "[esp+0x28] == NULL || {[esp+0x28], [esp+0x2c], [esp+0x30], [esp+0x34], ...} is a valid argv"],
                      effect: "execve(\"/bin/sh\", esp+0x28, environ)")
OneGadget::Gadget.add(build_id, 241322,
                      constraints: ["ebx is the GOT address of libc", "[esp+0x10] == NULL", "[esp] == NULL", "eax == NULL", "[esp+0x2c] == NULL || {[esp+0x2c], [esp+0x30], [esp+0x34], [esp+0x38], ...} is a valid argv"],
                      effect: "execve(\"/bin/sh\", esp+0x2c, environ)")
OneGadget::Gadget.add(build_id, 241323,
                      constraints: ["ebx is the GOT address of libc", "[esp+0x14] == NULL", "[esp+0x4] == NULL", "[esp] == NULL", "[esp+0x30] == NULL || {[esp+0x30], [esp+0x34], [esp+0x38], [esp+0x3c], ...} is a valid argv"],
                      effect: "execve(\"/bin/sh\", esp+0x30, environ)")
OneGadget::Gadget.add(build_id, 241325,
                      constraints: ["ebx is the GOT address of libc", "[esp+0x18] == NULL", "[esp+0x4] == NULL", "[esp+0x8] == NULL", "[esp+0x34] == NULL || {[esp+0x34], [esp+0x38], [esp+0x3c], [esp+0x40], ...} is a valid argv"],
                      effect: "execve(\"/bin/sh\", esp+0x34, environ)")
...
OneGadget::Gadget.add(build_id, 241339,
                      ...
                      effect: "execve(\"/bin/sh\", esp+0x30, environ)")
OneGadget::Gadget.add(build_id, 241341,
...
OneGadget::Gadget.add(build_id, 241355,
...
OneGadget::Gadget.add(build_id, 241365,
                      constraints: ["ebx is the GOT address of libc", "[esp+0x28] == NULL || {[esp+0x28], [esp+0x2c], [esp+0x30], [esp+0x34], ...} is a valid argv", "[[eax]] == NULL || [eax] == NULL || [eax] is a valid envp"],
                      effect: "execve(\"/bin/sh\", esp+0x28, [eax])")
OneGadget::Gadget.add(build_id, 241375,
                      constraints: ["ebx is the GOT address of libc", "[esp+0x28] == NULL || {[esp+0x28], [esp+0x2c], [esp+0x30], [esp+0x34], ...} is a valid argv", "[[eax]] == NULL || [eax] == NULL || [eax] is a valid envp"],
                      effect: "execve(\"/bin/sh\", esp+0x28, [eax])")
OneGadget::Gadget.add(build_id, 241377,
...
OneGadget::Gadget.add(build_id, 410564,
                      constraints: ["ebx is the GOT address of libc", "eax == NULL"],
                      effect: "execl(\"/bin/sh\", \"sh\", eax)")
OneGadget::Gadget.add(build_id, 410567,
                      constraints: ["ebx is the GOT address of libc", "eax == NULL"],
                      effect: "execl(\"/bin/sh\", \"sh\", eax)")
OneGadget::Gadget.add(build_id, 410569,
                      constraints: ["ebx is the GOT address of libc", "eax == NULL"],
                      effect: "execl(\"/bin/sh\", \"sh\", eax)")
OneGadget::Gadget.add(build_id, 410573,
                      constraints: ["ebx is the GOT address of libc", "eax == NULL"],
                      effect: "execl(\"/bin/sh\", \"sh\", eax)")
OneGadget::Gadget.add(build_id, 410574,
                      constraints: ["ebx is the GOT address of libc", "[esp] == NULL"],
                      effect: "execl(\"/bin/sh\", \"sh\", [esp])")
OneGadget::Gadget.add(build_id, 410580,
                      constraints: ["ebx is the GOT address of libc", "eax == NULL"],
                      effect: "execl(\"/bin/sh\", eax)")
OneGadget::Gadget.add(build_id, 410581,
                      constraints: ["ebx is the GOT address of libc", "[esp] == NULL"],
                      effect: "execl(\"/bin/sh\", [esp])")
OneGadget::Gadget.add(build_id, 734650,
...
OneGadget::Gadget.add(build_id, 734654,
...
OneGadget::Gadget.add(build_id, 734657,
...
OneGadget::Gadget.add(build_id, 735266,
...
OneGadget::Gadget.add(build_id, 735270,
                      ...
                      effect: "execve(\"/bin/sh\", [ebp-0x28], [ebp+0x10])")
OneGadget::Gadget.add(build_id, 735273,
                      ...
                      effect: "execve(\"/bin/sh\", [ebp-0x28], [ebp+0x10])")
OneGadget::Gadget.add(build_id, 735276,
                      ...
                      effect: "execve(\"/bin/sh\", [ebp-0x28], [ebp+0x10])")
OneGadget::Gadget.add(build_id, 735279,
                      ...
                      effect: "execve(\"/bin/sh\", [ebp-0x28], [ebp+0x10])")
OneGadget::Gadget.add(build_id, 735365,
...
OneGadget::Gadget.add(build_id, 735368,
                      constraints: ["ebx is the GOT address of libc", "esi == 0x1", "writable: eax", "writable: ebp-0x1c", "[ebp+0x8] == NULL || {\"sh\", [ebp+0x8], [eax+0x8], [eax+0xc], ...} is a valid argv", "[[ebp+0x10]] == NULL || [ebp+0x10] == NULL || [ebp+0x10] is a valid envp"],
                      effect: "execve(\"/bin/sh\", eax, [ebp+0x10])")
OneGadget::Gadget.add(build_id, 735598,
                      ...
                      effect: "execve(\"/bin/sh\", [ebp-0x28], [ebp+0x10])")
OneGadget::Gadget.add(build_id, 735601,
                      constraints: ["ebx is the GOT address of libc", "[ebp-0x44] == 0x1", "writable: eax", "writable: ebp-0x3c", "[ebp-0x40] == NULL || {\"sh\", [ebp-0x40], [eax+0x8], [eax+0xc], ...} is a valid argv", "[[ebp+0x10]] == NULL || [ebp+0x10] == NULL || [ebp+0x10] is a valid envp"],
                      effect: "execve(\"/bin/sh\", [ebp-0x28], [ebp+0x10])")
OneGadget::Gadget.add(build_id, 735612,
                      ...
                      effect: "execve(\"/bin/sh\", [ebp-0x28], [ebp+0x10])")
OneGadget::Gadget.add(build_id, 735615,
                      ...
                      effect: "execve(\"/bin/sh\", [ebp-0x28], [ebp+0x10])")
OneGadget::Gadget.add(build_id, 735618,
                      ...
                      effect: "execve(\"/bin/sh\", [ebp-0x28], [ebp+0x10])")
OneGadget::Gadget.add(build_id, 735621,
                      constraints: ["ebx is the GOT address of libc", "edx == 0x1", "writable: [ebp-0x28]", "ecx == NULL || {\"sh\", ecx, [[ebp-0x28]+0x8], [[ebp-0x28]+0xc], ...} is a valid argv", "[[ebp+0x10]] == NULL || [ebp+0x10] == NULL || [ebp+0x10] is a valid envp"],
                      effect: "execve(\"/bin/sh\", [ebp-0x28], [ebp+0x10])")
OneGadget::Gadget.add(build_id, 1191541,
                      constraints: ["ebx is the GOT address of libc", "eax == NULL"],
                      effect: "execl(\"/bin/sh\", \"sh\", eax)")
OneGadget::Gadget.add(build_id, 1191544,
                      constraints: ["ebx is the GOT address of libc", "eax == NULL"],
                      effect: "execl(\"/bin/sh\", \"sh\", eax)")
OneGadget::Gadget.add(build_id, 1191546,
                      constraints: ["ebx is the GOT address of libc", "eax == NULL"],
                      effect: "execl(\"/bin/sh\", \"sh\", eax)")
OneGadget::Gadget.add(build_id, 1191550,
                      constraints: ["ebx is the GOT address of libc", "eax == NULL"],
                      effect: "execl(\"/bin/sh\", \"sh\", eax)")
OneGadget::Gadget.add(build_id, 1191551,
                      constraints: ["ebx is the GOT address of libc", "[esp] == NULL"],
                      effect: "execl(\"/bin/sh\", \"sh\", [esp])")
OneGadget::Gadget.add(build_id, 1191557,
                      constraints: ["ebx is the GOT address of libc", "eax == NULL"],
                      effect: "execl(\"/bin/sh\", eax)")
OneGadget::Gadget.add(build_id, 1191558,
                      constraints: ["ebx is the GOT address of libc", "[esp] == NULL"],
                      effect: "execl(\"/bin/sh\", [esp])")
