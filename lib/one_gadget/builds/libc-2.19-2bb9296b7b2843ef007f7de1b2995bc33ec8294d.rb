...
# https://gitlab.com/david942j/libcdb/blob/master/libc/libc6-i686-2.19-19/lib/i386-linux-gnu/i686/cmov/libc-2.19.so
# 
# Intel 80386
# 
...
# Compiled on a Linux 4.0.5 system on 2015-07-09.
...
OneGadget::Gadget.add(build_id, 741666,
...
OneGadget::Gadget.add(build_id, 741670,
...
OneGadget::Gadget.add(build_id, 741673,
...
OneGadget::Gadget.add(build_id, 742598,
...
OneGadget::Gadget.add(build_id, 1194758,
                      constraints: ["ebx is the GOT address of libc", "eax == NULL"],
                      effect: "execl(\"/bin/sh\", \"sh\", eax)")
OneGadget::Gadget.add(build_id, 1194762,
                      constraints: ["ebx is the GOT address of libc", "[esp+0x8] == NULL"],
                      effect: "execl(\"/bin/sh\", \"sh\", [esp+0x8])")
OneGadget::Gadget.add(build_id, 1194768,
                      constraints: ["ebx is the GOT address of libc", "eax == NULL"],
                      effect: "execl(\"/bin/sh\", eax)")
OneGadget::Gadget.add(build_id, 1194772,
                      constraints: ["ebx is the GOT address of libc", "[esp+0x4] == NULL"],
                      effect: "execl(\"/bin/sh\", [esp+0x4])")
