...
# https://gitlab.com/david942j/libcdb/blob/master/libc/libc6-i686-2.19-14/lib/i386-linux-gnu/i686/cmov/libc-2.19.so
# 
# Intel 80386
# 
...
# Compiled on a Linux 3.16.7 system on 2015-02-01.
...
OneGadget::Gadget.add(build_id, 744066,
...
OneGadget::Gadget.add(build_id, 744070,
...
OneGadget::Gadget.add(build_id, 744073,
...
OneGadget::Gadget.add(build_id, 744998,
...
OneGadget::Gadget.add(build_id, 1197174,
                      constraints: ["ebx is the GOT address of libc", "eax == NULL"],
                      effect: "execl(\"/bin/sh\", \"sh\", eax)")
OneGadget::Gadget.add(build_id, 1197178,
                      constraints: ["ebx is the GOT address of libc", "[esp+0x8] == NULL"],
                      effect: "execl(\"/bin/sh\", \"sh\", [esp+0x8])")
OneGadget::Gadget.add(build_id, 1197184,
                      constraints: ["ebx is the GOT address of libc", "eax == NULL"],
                      effect: "execl(\"/bin/sh\", eax)")
OneGadget::Gadget.add(build_id, 1197188,
                      constraints: ["ebx is the GOT address of libc", "[esp+0x4] == NULL"],
                      effect: "execl(\"/bin/sh\", [esp+0x4])")
