...
# https://gitlab.com/david942j/libcdb/blob/master/libc/libc6-i686-2.19-7/lib/i386-linux-gnu/i686/cmov/libc-2.19.so
# 
# Intel 80386
# 
...
OneGadget::Gadget.add(build_id, 744418,
...
OneGadget::Gadget.add(build_id, 744422,
...
OneGadget::Gadget.add(build_id, 744425,
...
OneGadget::Gadget.add(build_id, 745350,
...
OneGadget::Gadget.add(build_id, 1197510,
                      constraints: ["ebx is the GOT address of libc", "eax == NULL"],
                      effect: "execl(\"/bin/sh\", \"sh\", eax)")
OneGadget::Gadget.add(build_id, 1197514,
                      constraints: ["ebx is the GOT address of libc", "[esp+0x8] == NULL"],
                      effect: "execl(\"/bin/sh\", \"sh\", [esp+0x8])")
OneGadget::Gadget.add(build_id, 1197520,
                      constraints: ["ebx is the GOT address of libc", "eax == NULL"],
                      effect: "execl(\"/bin/sh\", eax)")
OneGadget::Gadget.add(build_id, 1197524,
                      constraints: ["ebx is the GOT address of libc", "[esp+0x4] == NULL"],
                      effect: "execl(\"/bin/sh\", [esp+0x4])")
