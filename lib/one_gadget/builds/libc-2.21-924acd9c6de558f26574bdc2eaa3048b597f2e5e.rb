...
# https://gitlab.com/david942j/libcdb/blob/master/libc/libc0.1-i686-2.21-3/lib/i386-kfreebsd-gnu/i686/cmov/libc-2.21.so
# 
# Intel 80386
# 
...
OneGadget::Gadget.add(build_id, 643946,
...
OneGadget::Gadget.add(build_id, 643950,
...
OneGadget::Gadget.add(build_id, 643953,
...
OneGadget::Gadget.add(build_id, 644645,
...
OneGadget::Gadget.add(build_id, 644648,
                      constraints: ["ebx is the GOT address of libc", "esi == 0x1", "writable: eax", "writable: ebp-0x1c", "[ebp+0x8] == NULL || {\"sh\", [ebp+0x8], [eax+0x8], [eax+0xc], ...} is a valid argv", "[[ebp+0x10]] == NULL || [ebp+0x10] == NULL || [ebp+0x10] is a valid envp"],
                      effect: "execve(\"/bin/sh\", eax, [ebp+0x10])")
