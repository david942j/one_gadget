...
# https://gitlab.com/david942j/libcdb/blob/master/libc/libc0.1-i386-2.21-0experimental4/lib32/libc-2.21.so
# 
# Intel 80386
# 
...
OneGadget::Gadget.add(build_id, 644058,
...
OneGadget::Gadget.add(build_id, 644062,
...
OneGadget::Gadget.add(build_id, 644065,
...
OneGadget::Gadget.add(build_id, 644757,
...
OneGadget::Gadget.add(build_id, 644760,
                      constraints: ["ebx is the GOT address of libc", "esi == 0x1", "writable: eax", "writable: ebp-0x1c", "[ebp+0x8] == NULL || {\"sh\", [ebp+0x8], [eax+0x8], [eax+0xc], ...} is a valid argv", "[[ebp+0x10]] == NULL || [ebp+0x10] == NULL || [ebp+0x10] is a valid envp"],
                      effect: "execve(\"/bin/sh\", eax, [ebp+0x10])")
