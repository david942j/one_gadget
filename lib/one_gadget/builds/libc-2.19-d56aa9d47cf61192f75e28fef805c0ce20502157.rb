...
# https://gitlab.com/david942j/libcdb/blob/master/libc/libc0.1-2.19-3experimental0/lib/x86_64-kfreebsd-gnu/libc-2.19.so
# 
# Advanced Micro Devices X86-64 processor
# 
# GNU C Library (Debian GLIBC 2.19-3experimental0) stable release version 2.19, by Roland McGrath et al.
...
OneGadget::Gadget.add(build_id, 262874,
                      constraints: ["eax == 0x0", "{\"sh\", \"-c\", rbp, NULL} is a valid argv"],
                      effect: "execve(\"/bin/sh\", rsp+0x30, environ)")
OneGadget::Gadget.add(build_id, 262877,
...
OneGadget::Gadget.add(build_id, 700840,
...
OneGadget::Gadget.add(build_id, 700845,
...
OneGadget::Gadget.add(build_id, 700849,
...
OneGadget::Gadget.add(build_id, 700856,
                      ...
                      effect: "execve(\"/bin/sh\", rsi, r12)")
OneGadget::Gadget.add(build_id, 701469,
...
OneGadget::Gadget.add(build_id, 701473,
                      ...
                      effect: "execve(\"/bin/sh\", [rbp-0x48], r12)")
OneGadget::Gadget.add(build_id, 701480,
                      constraints: ["r14d == 0x1", "readable: rbp-0x48", "writable: rax", "[[rbp-0x48]] == NULL || [rbp-0x48] == NULL || [rbp-0x48] is a valid argv", "[r12] == NULL || r12 == NULL || r12 is a valid envp"],
                      effect: "execve(\"/bin/sh\", [rbp-0x48], r12)")
...
OneGadget::Gadget.add(build_id, 701644,
                      ...
                      effect: "execve(\"/bin/sh\", [rbp-0x48], r12)")
OneGadget::Gadget.add(build_id, 701685,
...
OneGadget::Gadget.add(build_id, 701698,
                      ...
                      effect: "execve(\"/bin/sh\", rax, r12)")
OneGadget::Gadget.add(build_id, 701702,
                      constraints: ["r14d == 0x1", "writable: [rbp-0x48]", "r15 == NULL || {\"sh\", r15, [[rbp-0x48]+0x10], [[rbp-0x48]+0x18], ...} is a valid argv", "[r12] == NULL || r12 == NULL || r12 is a valid envp"],
                      effect: "execve(\"/bin/sh\", [rbp-0x48], r12)")
OneGadget::Gadget.add(build_id, 701821,
...
OneGadget::Gadget.add(build_id, 823565,
                      constraints: ["ebx != 0x0", "[rsp+0x70] == NULL || {[rsp+0x70], [rsp+0x78], [rsp+0x80], [rsp+0x88], ...} is a valid argv"],
                      effect: "execve(\"/bin/sh\", rsp+0x70, environ)",
                      closed_fds: ["[rsp+0x60]"])
