...
# https://gitlab.com/david942j/libcdb/blob/master/libc/libc6_2.24-9ubuntu2_arm64/lib/aarch64-linux-gnu/libc-2.24.so
# 
...
OneGadget::Gadget.add(build_id, 248400,
                      constraints: ["writable: x19+0x258", "x22 == NULL", "x3+0x9f8 == NULL || {x3+0x9f8, \"-c\", x24, NULL} is a valid argv"],
                      effect: "execve(\"/bin/sh\", sp+0x68, environ)")
...
OneGadget::Gadget.add(build_id, 248412,
                      constraints: ["writable: x19+0x258", "writable: x20+0x4", "x22 == NULL", "x3 == NULL || {x3, x0+0xa00, x24, NULL} is a valid argv"],
                      effect: "execve(\"/bin/sh\", sp+0x68, environ)")
...
OneGadget::Gadget.add(build_id, 399004,
                      constraints: ["x1 == NULL"],
                      effect: "execl(\"/bin/sh\", x1)")
OneGadget::Gadget.add(build_id, 643192,
