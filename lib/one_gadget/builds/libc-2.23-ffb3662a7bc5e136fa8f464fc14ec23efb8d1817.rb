...
# https://gitlab.com/david942j/libcdb/blob/master/libc/glibc-2.23-3-x86_64.pkg.tar/usr/lib/libc-2.23.so
# 
...
OneGadget::Gadget.add(build_id, 753621,
...
OneGadget::Gadget.add(build_id, 753624,
                      constraints: ["r12d == 0x1", "writable: (rsp+0xf & 0xfffffffffffffff0)", "r14 == NULL || {\"sh\", r14, [(rsp+0xf & 0xfffffffffffffff0)+0x10], [(rsp+0xf & 0xfffffffffffffff0)+0x18], ...} is a valid argv", "[rbx] == NULL || rbx == NULL || rbx is a valid envp"],
                      effect: "execve(\"/bin/sh\", (rsp+0xf & 0xfffffffffffffff0), rbx)")
OneGadget::Gadget.add(build_id, 753629,
...
OneGadget::Gadget.add(build_id, 753633,
...
OneGadget::Gadget.add(build_id, 754191,
                      ...
                      effect: "execve(\"/bin/sh\", (rsp+0xf & 0xfffffffffffffff0), rbx)")
OneGadget::Gadget.add(build_id, 754196,
...
OneGadget::Gadget.add(build_id, 754208,
                      ...
                      effect: "execve(\"/bin/sh\", [rbp-0x38], rbx)")
OneGadget::Gadget.add(build_id, 754215,
                      constraints: ["r12d == 0x1", "readable: rbp-0x38", "writable: rax", "[[rbp-0x38]] == NULL || [rbp-0x38] == NULL || [rbp-0x38] is a valid argv", "[rbx] == NULL || rbx == NULL || rbx is a valid envp"],
                      effect: "execve(\"/bin/sh\", [rbp-0x38], rbx)")
OneGadget::Gadget.add(build_id, 754294,
                      ...
                      effect: "execve(\"/bin/sh\", rax, rbx)")
OneGadget::Gadget.add(build_id, 754507,
...
OneGadget::Gadget.add(build_id, 754520,
                      ...
                      effect: "execve(\"/bin/sh\", rax, rbx)")
OneGadget::Gadget.add(build_id, 754524,
                      ...
                      effect: "execve(\"/bin/sh\", [rbp-0x38], rbx)")
OneGadget::Gadget.add(build_id, 754528,
                      constraints: ["r12d == 0x1", "writable: [rbp-0x38]", "r8 == NULL || {\"sh\", r8, [[rbp-0x38]+0x10], [[rbp-0x38]+0x18], ...} is a valid argv", "[rbx] == NULL || rbx == NULL || rbx is a valid envp"],
                      effect: "execve(\"/bin/sh\", [rbp-0x38], rbx)")
OneGadget::Gadget.add(build_id, 754533,
                      ...
                      effect: "execve(\"/bin/sh\", [rbp-0x38], rbx)")
OneGadget::Gadget.add(build_id, 875723,
...
OneGadget::Gadget.add(build_id, 875727,
                      constraints: ["[rsp+0x1c] != 0x0", "[rsp+0x70] == NULL || {[rsp+0x70], [rsp+0x78], [rsp+0x80], [rsp+0x88], ...} is a valid argv"],
                      effect: "execve(\"/bin/sh\", rsp+0x70, environ)",
                      closed_fds: ["rdi", "[rsp+0x60]"])
OneGadget::Gadget.add(build_id, 875732,
                      constraints: ["[rsp+0x1c] != 0x0", "[rsp+0x70] == NULL || {[rsp+0x70], [rsp+0x78], [rsp+0x80], [rsp+0x88], ...} is a valid argv"],
                      effect: "execve(\"/bin/sh\", rsp+0x70, environ)",
                      closed_fds: ["[rsp+0x60]"])
OneGadget::Gadget.add(build_id, 875736,
                      constraints: ["ecx != 0x0", "[rsp+0x70] == NULL || {[rsp+0x70], [rsp+0x78], [rsp+0x80], [rsp+0x88], ...} is a valid argv"],
                      effect: "execve(\"/bin/sh\", rsp+0x70, environ)",
                      closed_fds: ["[rsp+0x60]"])
OneGadget::Gadget.add(build_id, 875826,
...
OneGadget::Gadget.add(build_id, 876117,
                      constraints: ["[rsp+0x70] == NULL || {[rsp+0x70], [rsp+0x78], [rsp+0x80], [rsp+0x88], ...} is a valid argv"],
                      effect: "execve(\"/bin/sh\", rsp+0x70, environ)")
OneGadget::Gadget.add(build_id, 876124,
...
OneGadget::Gadget.add(build_id, 876168,
                      constraints: ["[rsp+0x1c] != 0x0", "[rsp+0x70] == NULL || {[rsp+0x70], [rsp+0x78], [rsp+0x80], [rsp+0x88], ...} is a valid argv"],
                      effect: "execve(\"/bin/sh\", rsp+0x70, environ)",
                      closed_fds: ["[rsp+0x60]"])
