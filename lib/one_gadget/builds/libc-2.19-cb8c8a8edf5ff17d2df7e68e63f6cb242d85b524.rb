...
# https://gitlab.com/david942j/libcdb/blob/master/libc/libc0.1-i386-2.19-19/lib32/libc-2.19.so
# 
# Intel 80386
# 
...
OneGadget::Gadget.add(build_id, 655570,
...
OneGadget::Gadget.add(build_id, 655574,
...
OneGadget::Gadget.add(build_id, 655577,
...
OneGadget::Gadget.add(build_id, 656502,
