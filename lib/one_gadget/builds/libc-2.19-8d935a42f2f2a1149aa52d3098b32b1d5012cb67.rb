...
# https://gitlab.com/david942j/libcdb/blob/master/libc/libc6_2.19-10ubuntu2.3_arm64/lib/aarch64-linux-gnu/libc-2.19.so
# 
...
OneGadget::Gadget.add(build_id, 261724,
                      constraints: ["writable: x21+0x2e0", "x23 == NULL", "x3+0x3b0 == NULL || {x3+0x3b0, \"-c\", x22, x1, ...} is a valid argv"],
                      effect: "execve(\"/bin/sh\", sp+0x68, environ)")
OneGadget::Gadget.add(build_id, 261728,
                      constraints: ["writable: x20", "writable: x21+0x2e0", "x23 == NULL", "x3+0x3b0 == NULL || {x3+0x3b0, \"-c\", x22, x1, ...} is a valid argv"],
...
OneGadget::Gadget.add(build_id, 650076,
...
OneGadget::Gadget.add(build_id, 650080,
...
OneGadget::Gadget.add(build_id, 650084,
                      constraints: ["w19 == 0x1", "writable: x1", "x20 == NULL || {\"sh\", x20, [x1+0x10], [x1+0x18], ...} is a valid argv", "[x22] == NULL || x22 == NULL || x22 is a valid envp"],
                      effect: "execve(\"/bin/sh\", x1, x22)")
OneGadget::Gadget.add(build_id, 650828,
...
OneGadget::Gadget.add(build_id, 650832,
                      constraints: ["w19 == 0x1", "writable: x0", "x20 == NULL || {\"sh\", x20, [x0+0x10], [x0+0x18], ...} is a valid argv", "[x22] == NULL || x22 == NULL || x22 is a valid envp"],
                      effect: "execve(\"/bin/sh\", x0, x22)")
OneGadget::Gadget.add(build_id, 650836,
