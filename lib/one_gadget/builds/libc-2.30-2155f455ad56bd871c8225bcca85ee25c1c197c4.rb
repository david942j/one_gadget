...
# https://gitlab.com/david942j/libcdb/blob/master/libc/libc6_2.30-0ubuntu2_amd64/lib/x86_64-linux-gnu/libc-2.30.so
# 
...
OneGadget::Gadget.add(build_id, 348403,
                      constraints: ["rsp & 0xf == 0x0", "writable: rsp+0x60", "{\"sh\", \"-c\", rbx, NULL} is a valid argv", "r12 == NULL || (u16)[r12] == 0x0"],
                      effect: "posix_spawn(rsp+0xc, \"/bin/sh\", 0, r12, rsp+0x50, environ)")
OneGadget::Gadget.add(build_id, 348410,
                      constraints: ["rsp & 0xf == 0x0", "writable: rsp+0x60", "rax == NULL || {\"sh\", rax, rbx, NULL} is a valid argv", "r12 == NULL || (u16)[r12] == 0x0"],
                      effect: "posix_spawn(rsp+0xc, \"/bin/sh\", 0, r12, rsp+0x50, environ)")
OneGadget::Gadget.add(build_id, 348422,
                      constraints: ["rsp & 0xf == 0x0", "writable: rsp+0x60", "(u64)xmm1 == NULL || {\"sh\", (u64)xmm1, rbx, NULL} is a valid argv", "rdi == NULL || writable: rdi", "rdx == NULL || (s32)[rdx+0x4] <= 0x0", "r12 == NULL || (u16)[r12] == 0x0"],
                      effect: "posix_spawn(rdi, \"/bin/sh\", rdx, r12, rsp+0x50, environ)")
OneGadget::Gadget.add(build_id, 348436,
                      constraints: ["rsp & 0xf == 0x0", "writable: rsp+0x60", "rcx == NULL || {rcx, (u64)xmm1, rbx, NULL} is a valid argv", "[[rax]] == NULL || [rax] == NULL || [rax] is a valid envp", "rdi == NULL || writable: rdi", "rdx == NULL || (s32)[rdx+0x4] <= 0x0", "r12 == NULL || (u16)[r12] == 0x0"],
                      effect: "posix_spawn(rdi, \"/bin/sh\", rdx, r12, rsp+0x50, [rax])")
OneGadget::Gadget.add(build_id, 348446,
                      constraints: ["rsp & 0xf == 0x0", "writable: rsp+0x60", "[r8] == NULL || r8 is a valid argv", "[[rax]] == NULL || [rax] == NULL || [rax] is a valid envp", "rdi == NULL || writable: rdi", "rdx == NULL || (s32)[rdx+0x4] <= 0x0", "r12 == NULL || (u16)[r12] == 0x0"],
...
OneGadget::Gadget.add(build_id, 553443,
                      constraints: ["rsp & 0xf == 0x0", "writable: rsp+0x78", "[r8] == NULL || r8 is a valid argv", "[r9] == NULL || r9 == NULL || r9 is a valid envp", "rdi == NULL || writable: rdi", "rdx == NULL || (s32)[rdx+0x4] <= 0x0", "rcx == NULL || (u16)[rcx] == 0x0"],
