...
# https://gitlab.com/david942j/libcdb/blob/master/libc/libc0.1-i386-2.19-14/lib32/libc-2.19.so
# 
# Intel 80386
# 
...
OneGadget::Gadget.add(build_id, 657954,
...
OneGadget::Gadget.add(build_id, 657958,
...
OneGadget::Gadget.add(build_id, 657961,
...
OneGadget::Gadget.add(build_id, 658886,
