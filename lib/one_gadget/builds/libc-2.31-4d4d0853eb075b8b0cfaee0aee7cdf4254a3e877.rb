...
# https://gitlab.com/david942j/libcdb/blob/master/libc/libc6-amd64_2.31-0ubuntu9.2_i386/lib64/libc-2.31.so
# 
...
OneGadget::Gadget.add(build_id, 300292,
                      constraints: ["writable: rsp+0x60", "{\"sh\", \"-c\", rbx, NULL} is a valid argv", "r13 == NULL || (u16)[r13] == 0x0"],
