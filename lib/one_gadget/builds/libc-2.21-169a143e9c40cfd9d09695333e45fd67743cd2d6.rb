...
# https://gitlab.com/david942j/libcdb/blob/master/libc/libc6_2.21-0ubuntu4_arm64/lib/aarch64-linux-gnu/libc-2.21.so
# 
...
OneGadget::Gadget.add(build_id, 252896,
                      constraints: ["writable: x19+0x2a0", "writable: x20+0x4", "x21 == NULL", "x4+0x9d8 == NULL || {x4+0x9d8, \"-c\", x23, NULL} is a valid argv"],
                      effect: "execve(\"/bin/sh\", sp+0x58, environ)")
OneGadget::Gadget.add(build_id, 252900,
                      constraints: ["writable: x19+0x2a0", "writable: x20+0x4", "x21 == NULL", "x4+0x9d8 == NULL || {x4+0x9d8, x3+0x9e0, x23, NULL} is a valid argv"],
                      effect: "execve(\"/bin/sh\", sp+0x58, environ)")
OneGadget::Gadget.add(build_id, 252904,
                      constraints: ["writable: x19+0x2a0", "writable: x20+0x4", "x21 == NULL", "x4 == NULL || {x4, x3+0x9e0, x23, NULL} is a valid argv"],
                      effect: "execve(\"/bin/sh\", sp+0x58, environ)")
...
OneGadget::Gadget.add(build_id, 408244,
                      ...
                      effect: "execl(\"/bin/sh\", \"sh\", x2+0x9e0)")
OneGadget::Gadget.add(build_id, 408248,
                      constraints: ["x1+0x9d8 == NULL"],
                      effect: "execl(\"/bin/sh\", x1+0x9d8)")
OneGadget::Gadget.add(build_id, 647948,
...
OneGadget::Gadget.add(build_id, 647952,
...
OneGadget::Gadget.add(build_id, 648584,
...
OneGadget::Gadget.add(build_id, 648588,
                      constraints: ["w21 == 0x1", "writable: x0", "x23 == NULL || {\"sh\", x23, [x0+0x10], [x0+0x18], ...} is a valid argv", "[x20] == NULL || x20 == NULL || x20 is a valid envp"],
                      effect: "execve(\"/bin/sh\", x0, x20)")
OneGadget::Gadget.add(build_id, 648592,
