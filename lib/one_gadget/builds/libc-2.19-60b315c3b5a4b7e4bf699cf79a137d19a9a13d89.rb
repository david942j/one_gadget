...
# https://gitlab.com/david942j/libcdb/blob/master/libc/lib32-glibc-2.19-5-x86_64.pkg.tar/usr/lib32/libc-2.19.so
# 
# Intel 80386
# 
...
OneGadget::Gadget.add(build_id, 242008,
...
OneGadget::Gadget.add(build_id, 242600,
                      ...
                      effect: "execve(\"/bin/sh\", esp+0x24, environ)")
OneGadget::Gadget.add(build_id, 242606,
...
OneGadget::Gadget.add(build_id, 242632,
                      ...
                      effect: "execve(\"/bin/sh\", esp+0x24, environ)")
OneGadget::Gadget.add(build_id, 242636,
                      ...
                      effect: "execve(\"/bin/sh\", esp+0x24, environ)")
OneGadget::Gadget.add(build_id, 242637,
...
OneGadget::Gadget.add(build_id, 242646,
...
OneGadget::Gadget.add(build_id, 242648,
...
OneGadget::Gadget.add(build_id, 242653,
                      ...
                      effect: "execve(\"/bin/sh\", esp+0x34, environ)")
OneGadget::Gadget.add(build_id, 242659,
...
OneGadget::Gadget.add(build_id, 242662,
                      constraints: ["ebx is the GOT address of libc", "[esp+0xc] == NULL", "eax == NULL", "[esp+0x28] == NULL || {[esp+0x28], [esp+0x2c], [esp+0x30], [esp+0x34], ...} is a valid argv"],
                      effect: "execve(\"/bin/sh\", esp+0x28, environ)")
OneGadget::Gadget.add(build_id, 242664,
                      constraints: ["ebx is the GOT address of libc", "[esp+0x10] == NULL", "[esp] == NULL", "eax == NULL", "[esp+0x2c] == NULL || {[esp+0x2c], [esp+0x30], [esp+0x34], [esp+0x38], ...} is a valid argv"],
                      effect: "execve(\"/bin/sh\", esp+0x2c, environ)")
OneGadget::Gadget.add(build_id, 242665,
                      constraints: ["ebx is the GOT address of libc", "[esp+0x14] == NULL", "[esp+0x4] == NULL", "[esp] == NULL", "[esp+0x30] == NULL || {[esp+0x30], [esp+0x34], [esp+0x38], [esp+0x3c], ...} is a valid argv"],
                      effect: "execve(\"/bin/sh\", esp+0x30, environ)")
OneGadget::Gadget.add(build_id, 242667,
                      constraints: ["ebx is the GOT address of libc", "[esp+0x18] == NULL", "[esp+0x4] == NULL", "[esp+0x8] == NULL", "[esp+0x34] == NULL || {[esp+0x34], [esp+0x38], [esp+0x3c], [esp+0x40], ...} is a valid argv"],
                      effect: "execve(\"/bin/sh\", esp+0x34, environ)")
OneGadget::Gadget.add(build_id, 242672,
                      constraints: ["ebx is the GOT address of libc", "[esp+0x18] == NULL", "[esp+0x34] == NULL || {[esp+0x34], [esp+0x38], [esp+0x3c], [esp+0x40], ...} is a valid argv"],
                      effect: "execve(\"/bin/sh\", esp+0x34, environ)")
...
OneGadget::Gadget.add(build_id, 242681,
                      ...
                      effect: "execve(\"/bin/sh\", esp+0x30, environ)")
OneGadget::Gadget.add(build_id, 242683,
...
OneGadget::Gadget.add(build_id, 242688,
                      ...
                      effect: "execve(\"/bin/sh\", esp+0x34, environ)")
OneGadget::Gadget.add(build_id, 242694,
...
OneGadget::Gadget.add(build_id, 242697,
...
OneGadget::Gadget.add(build_id, 242707,
                      constraints: ["ebx is the GOT address of libc", "[esp+0x28] == NULL || {[esp+0x28], [esp+0x2c], [esp+0x30], [esp+0x34], ...} is a valid argv", "[[eax]] == NULL || [eax] == NULL || [eax] is a valid envp"],
                      effect: "execve(\"/bin/sh\", esp+0x28, [eax])")
OneGadget::Gadget.add(build_id, 242717,
                      constraints: ["ebx is the GOT address of libc", "[esp+0x28] == NULL || {[esp+0x28], [esp+0x2c], [esp+0x30], [esp+0x34], ...} is a valid argv", "[[eax]] == NULL || [eax] == NULL || [eax] is a valid envp"],
                      effect: "execve(\"/bin/sh\", esp+0x28, [eax])")
OneGadget::Gadget.add(build_id, 242719,
...
OneGadget::Gadget.add(build_id, 412244,
                      constraints: ["ebx is the GOT address of libc", "eax == NULL"],
                      effect: "execl(\"/bin/sh\", \"sh\", eax)")
OneGadget::Gadget.add(build_id, 412247,
                      constraints: ["ebx is the GOT address of libc", "eax == NULL"],
                      effect: "execl(\"/bin/sh\", \"sh\", eax)")
OneGadget::Gadget.add(build_id, 412249,
                      constraints: ["ebx is the GOT address of libc", "eax == NULL"],
                      effect: "execl(\"/bin/sh\", \"sh\", eax)")
OneGadget::Gadget.add(build_id, 412253,
                      constraints: ["ebx is the GOT address of libc", "eax == NULL"],
                      effect: "execl(\"/bin/sh\", \"sh\", eax)")
OneGadget::Gadget.add(build_id, 412254,
                      constraints: ["ebx is the GOT address of libc", "[esp] == NULL"],
                      effect: "execl(\"/bin/sh\", \"sh\", [esp])")
OneGadget::Gadget.add(build_id, 412260,
                      constraints: ["ebx is the GOT address of libc", "eax == NULL"],
                      effect: "execl(\"/bin/sh\", eax)")
OneGadget::Gadget.add(build_id, 412261,
                      constraints: ["ebx is the GOT address of libc", "[esp] == NULL"],
                      effect: "execl(\"/bin/sh\", [esp])")
OneGadget::Gadget.add(build_id, 737786,
...
OneGadget::Gadget.add(build_id, 737790,
...
OneGadget::Gadget.add(build_id, 737793,
...
OneGadget::Gadget.add(build_id, 738402,
...
OneGadget::Gadget.add(build_id, 738406,
                      ...
                      effect: "execve(\"/bin/sh\", [ebp-0x28], [ebp+0x10])")
OneGadget::Gadget.add(build_id, 738409,
                      ...
                      effect: "execve(\"/bin/sh\", [ebp-0x28], [ebp+0x10])")
OneGadget::Gadget.add(build_id, 738412,
                      ...
                      effect: "execve(\"/bin/sh\", [ebp-0x28], [ebp+0x10])")
OneGadget::Gadget.add(build_id, 738415,
                      ...
                      effect: "execve(\"/bin/sh\", [ebp-0x28], [ebp+0x10])")
OneGadget::Gadget.add(build_id, 738501,
...
OneGadget::Gadget.add(build_id, 738504,
                      constraints: ["ebx is the GOT address of libc", "esi == 0x1", "writable: eax", "writable: ebp-0x1c", "[ebp+0x8] == NULL || {\"sh\", [ebp+0x8], [eax+0x8], [eax+0xc], ...} is a valid argv", "[[ebp+0x10]] == NULL || [ebp+0x10] == NULL || [ebp+0x10] is a valid envp"],
                      effect: "execve(\"/bin/sh\", eax, [ebp+0x10])")
OneGadget::Gadget.add(build_id, 738734,
                      ...
                      effect: "execve(\"/bin/sh\", [ebp-0x28], [ebp+0x10])")
OneGadget::Gadget.add(build_id, 738737,
                      constraints: ["ebx is the GOT address of libc", "[ebp-0x44] == 0x1", "writable: eax", "writable: ebp-0x3c", "[ebp-0x40] == NULL || {\"sh\", [ebp-0x40], [eax+0x8], [eax+0xc], ...} is a valid argv", "[[ebp+0x10]] == NULL || [ebp+0x10] == NULL || [ebp+0x10] is a valid envp"],
                      effect: "execve(\"/bin/sh\", [ebp-0x28], [ebp+0x10])")
OneGadget::Gadget.add(build_id, 738748,
                      ...
                      effect: "execve(\"/bin/sh\", [ebp-0x28], [ebp+0x10])")
OneGadget::Gadget.add(build_id, 738751,
                      ...
                      effect: "execve(\"/bin/sh\", [ebp-0x28], [ebp+0x10])")
OneGadget::Gadget.add(build_id, 738754,
                      ...
                      effect: "execve(\"/bin/sh\", [ebp-0x28], [ebp+0x10])")
OneGadget::Gadget.add(build_id, 738757,
                      constraints: ["ebx is the GOT address of libc", "edx == 0x1", "writable: [ebp-0x28]", "ecx == NULL || {\"sh\", ecx, [[ebp-0x28]+0x8], [[ebp-0x28]+0xc], ...} is a valid argv", "[[ebp+0x10]] == NULL || [ebp+0x10] == NULL || [ebp+0x10] is a valid envp"],
                      effect: "execve(\"/bin/sh\", [ebp-0x28], [ebp+0x10])")
OneGadget::Gadget.add(build_id, 1195877,
                      constraints: ["ebx is the GOT address of libc", "eax == NULL"],
                      effect: "execl(\"/bin/sh\", \"sh\", eax)")
OneGadget::Gadget.add(build_id, 1195880,
                      constraints: ["ebx is the GOT address of libc", "eax == NULL"],
                      effect: "execl(\"/bin/sh\", \"sh\", eax)")
OneGadget::Gadget.add(build_id, 1195882,
                      constraints: ["ebx is the GOT address of libc", "eax == NULL"],
                      effect: "execl(\"/bin/sh\", \"sh\", eax)")
OneGadget::Gadget.add(build_id, 1195886,
                      constraints: ["ebx is the GOT address of libc", "eax == NULL"],
                      effect: "execl(\"/bin/sh\", \"sh\", eax)")
OneGadget::Gadget.add(build_id, 1195887,
                      constraints: ["ebx is the GOT address of libc", "[esp] == NULL"],
                      effect: "execl(\"/bin/sh\", \"sh\", [esp])")
OneGadget::Gadget.add(build_id, 1195893,
                      constraints: ["ebx is the GOT address of libc", "eax == NULL"],
                      effect: "execl(\"/bin/sh\", eax)")
OneGadget::Gadget.add(build_id, 1195894,
                      constraints: ["ebx is the GOT address of libc", "[esp] == NULL"],
                      effect: "execl(\"/bin/sh\", [esp])")
