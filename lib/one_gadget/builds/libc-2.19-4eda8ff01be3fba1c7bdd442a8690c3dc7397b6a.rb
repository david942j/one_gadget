...
# https://gitlab.com/david942j/libcdb/blob/master/libc/libc6-amd64_2.19-0ubuntu6.14_i386/lib64/libc-2.19.so
# 
...
OneGadget::Gadget.add(build_id, 763464,
...
OneGadget::Gadget.add(build_id, 763469,
...
OneGadget::Gadget.add(build_id, 763473,
...
OneGadget::Gadget.add(build_id, 763480,
                      ...
                      effect: "execve(\"/bin/sh\", rsi, r12)")
OneGadget::Gadget.add(build_id, 764093,
...
OneGadget::Gadget.add(build_id, 764097,
                      ...
                      effect: "execve(\"/bin/sh\", [rbp-0x48], r12)")
OneGadget::Gadget.add(build_id, 764104,
                      constraints: ["r14d == 0x1", "readable: rbp-0x48", "writable: rax", "[[rbp-0x48]] == NULL || [rbp-0x48] == NULL || [rbp-0x48] is a valid argv", "[r12] == NULL || r12 == NULL || r12 is a valid envp"],
                      effect: "execve(\"/bin/sh\", [rbp-0x48], r12)")
...
OneGadget::Gadget.add(build_id, 764268,
                      ...
                      effect: "execve(\"/bin/sh\", [rbp-0x48], r12)")
OneGadget::Gadget.add(build_id, 764309,
...
OneGadget::Gadget.add(build_id, 764322,
                      ...
                      effect: "execve(\"/bin/sh\", rax, r12)")
OneGadget::Gadget.add(build_id, 764326,
                      constraints: ["r14d == 0x1", "writable: [rbp-0x48]", "r15 == NULL || {\"sh\", r15, [[rbp-0x48]+0x10], [[rbp-0x48]+0x18], ...} is a valid argv", "[r12] == NULL || r12 == NULL || r12 is a valid envp"],
                      effect: "execve(\"/bin/sh\", [rbp-0x48], r12)")
OneGadget::Gadget.add(build_id, 764445,
...
OneGadget::Gadget.add(build_id, 883065,
                      constraints: ["([rsp+0x40] & 0x10) != 0x0", "(s64)[$base+0x3aa608] <= 0x0", "[rsp+0x64] == 0x1", "ebx == 0x0", "{\"sh\", \"-c\", [rsp+0x30], NULL} is a valid argv"],
                      effect: "execve(\"/bin/sh\", rsp+0x70, environ)",
                      closed_fds: ["[rsp+0x60]"])
OneGadget::Gadget.add(build_id, 883073,
                      constraints: ["([rsp+0x40] & 0x10) != 0x0", "(s64)[$base+0x3aa608] <= 0x0", "[rsp+0x64] == 0x1", "{\"sh\", \"-c\", [rsp+0x30], NULL} is a valid argv"],
                      effect: "execve(\"/bin/sh\", rsp+0x70, environ)",
                      closed_fds: ["[rsp+0x60]"])
OneGadget::Gadget.add(build_id, 883080,
                      constraints: ["([rsp+0x40] & 0x10) != 0x0", "(s64)[$base+0x3aa608] <= 0x0", "[rsp+0x64] == 0x1", "rax == NULL || {rax, \"-c\", [rsp+0x30], NULL} is a valid argv"],
                      effect: "execve(\"/bin/sh\", rsp+0x70, environ)",
                      closed_fds: ["[rsp+0x60]"])
OneGadget::Gadget.add(build_id, 883084,
                      constraints: ["(ebx & 0x10) != 0x0", "(s64)[$base+0x3aa608] <= 0x0", "[rsp+0x64] == 0x1", "rax == NULL || {rax, \"-c\", [rsp+0x30], NULL} is a valid argv"],
                      effect: "execve(\"/bin/sh\", rsp+0x70, environ)",
                      closed_fds: ["[rsp+0x60]"])
OneGadget::Gadget.add(build_id, 883096,
                      constraints: ["(ebx & 0x10) != 0x0", "(s64)[$base+0x3aa608] <= 0x0", "[rsp+0x64] == 0x1", "rax == NULL || {rax, \"-c\", [rsp+0x30], [rsp+0x88], ...} is a valid argv"],
                      effect: "execve(\"/bin/sh\", rsp+0x70, environ)",
                      closed_fds: ["[rsp+0x60]"])
OneGadget::Gadget.add(build_id, 883101,
                      constraints: ["(ebx & 0x10) != 0x0", "(s64)[$base+0x3aa608] <= 0x0", "[rsp+0x64] == 0x1", "[rsp+0x70] == NULL || {[rsp+0x70], \"-c\", [rsp+0x30], [rsp+0x88], ...} is a valid argv"],
                      effect: "execve(\"/bin/sh\", rsp+0x70, environ)",
                      closed_fds: ["[rsp+0x60]"])
OneGadget::Gadget.add(build_id, 883108,
                      constraints: ["(ebx & 0x10) != 0x0", "(s64)[$base+0x3aa608] <= 0x0", "[rsp+0x64] == 0x1", "[rsp+0x70] == NULL || {[rsp+0x70], rax, [rsp+0x30], [rsp+0x88], ...} is a valid argv"],
                      effect: "execve(\"/bin/sh\", rsp+0x70, environ)",
                      closed_fds: ["[rsp+0x60]"])
OneGadget::Gadget.add(build_id, 883111,
                      constraints: ["(s64)[$base+0x3aa608] <= 0x0", "[rsp+0x64] == 0x1", "ebx != 0x0", "[rsp+0x70] == NULL || {[rsp+0x70], rax, [rsp+0x30], [rsp+0x88], ...} is a valid argv"],
                      effect: "execve(\"/bin/sh\", rsp+0x70, environ)",
                      closed_fds: ["[rsp+0x60]"])
OneGadget::Gadget.add(build_id, 883116,
                      constraints: ["(s64)[$base+0x3aa608] <= 0x0", "[rsp+0x64] == 0x1", "ebx != 0x0", "[rsp+0x70] == NULL || {[rsp+0x70], [rsp+0x78], [rsp+0x30], [rsp+0x88], ...} is a valid argv"],
                      effect: "execve(\"/bin/sh\", rsp+0x70, environ)",
                      closed_fds: ["[rsp+0x60]"])
OneGadget::Gadget.add(build_id, 883121,
                      constraints: ["(s64)[$base+0x3aa608] <= 0x0", "[rsp+0x64] == 0x1", "ebx != 0x0", "[rsp+0x70] == NULL || {[rsp+0x70], [rsp+0x78], rax, [rsp+0x88], ...} is a valid argv"],
                      effect: "execve(\"/bin/sh\", rsp+0x70, environ)",
                      closed_fds: ["[rsp+0x60]"])
OneGadget::Gadget.add(build_id, 883129,
                      constraints: ["(s64)[$base+0x3aa608] <= 0x0", "[rsp+0x64] == 0x1", "ebx != 0x0", "[rsp+0x70] == NULL || {[rsp+0x70], [rsp+0x78], [rsp+0x80], [rsp+0x88], ...} is a valid argv"],
                      effect: "execve(\"/bin/sh\", rsp+0x70, environ)",
                      closed_fds: ["[rsp+0x60]"])
OneGadget::Gadget.add(build_id, 883133,
                      constraints: ["(s64)[$base+0x3aa608] <= 0x0", "ebx != 0x0", "edi == 0x1", "[rsp+0x70] == NULL || {[rsp+0x70], [rsp+0x78], [rsp+0x80], [rsp+0x88], ...} is a valid argv"],
                      effect: "execve(\"/bin/sh\", rsp+0x70, environ)",
                      closed_fds: ["[rsp+0x60]"])
OneGadget::Gadget.add(build_id, 883152,
                      constraints: ["ebx != 0x0", "[rsp+0x70] == NULL || {[rsp+0x70], [rsp+0x78], [rsp+0x80], [rsp+0x88], ...} is a valid argv"],
                      effect: "execve(\"/bin/sh\", rsp+0x70, environ)",
                      closed_fds: ["[rsp+0x64]", "[rsp+0x60]"])
OneGadget::Gadget.add(build_id, 883156,
                      constraints: ["ebx != 0x0", "[rsp+0x70] == NULL || {[rsp+0x70], [rsp+0x78], [rsp+0x80], [rsp+0x88], ...} is a valid argv"],
                      effect: "execve(\"/bin/sh\", rsp+0x70, environ)",
                      closed_fds: ["rdi", "[rsp+0x60]"])
OneGadget::Gadget.add(build_id, 883161,
                      constraints: ["ebx != 0x0", "[rsp+0x70] == NULL || {[rsp+0x70], [rsp+0x78], [rsp+0x80], [rsp+0x88], ...} is a valid argv"],
                      effect: "execve(\"/bin/sh\", rsp+0x70, environ)",
                      closed_fds: ["[rsp+0x60]"])
OneGadget::Gadget.add(build_id, 883232,
...
OneGadget::Gadget.add(build_id, 883528,
                      constraints: ["[rsp+0x70] == NULL || {[rsp+0x70], [rsp+0x78], [rsp+0x80], [rsp+0x88], ...} is a valid argv"],
                      effect: "execve(\"/bin/sh\", rsp+0x70, environ)")
OneGadget::Gadget.add(build_id, 883535,
...
OneGadget::Gadget.add(build_id, 883592,
                      constraints: ["(s64)[$base+0x3aa608] <= 0x0", "ebx != 0x0", "[rsp+0x70] == NULL || {[rsp+0x70], [rsp+0x78], [rsp+0x80], [rsp+0x88], ...} is a valid argv"],
                      effect: "execve(\"/bin/sh\", rsp+0x70, environ)",
                      closed_fds: ["[rsp+0x60]"])
OneGadget::Gadget.add(build_id, 883624,
                      constraints: ["ebx != 0x0", "[rsp+0x70] == NULL || {[rsp+0x70], [rsp+0x78], [rsp+0x80], [rsp+0x88], ...} is a valid argv"],
                      effect: "execve(\"/bin/sh\", rsp+0x70, environ)",
                      closed_fds: ["[rsp+0x60]"])
