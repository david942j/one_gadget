...
# https://gitlab.com/david942j/libcdb/blob/master/libc/libc6-i386-2.19-12/lib32/libc-2.19.so
# 
# Intel 80386
# 
...
OneGadget::Gadget.add(build_id, 743698,
...
OneGadget::Gadget.add(build_id, 743702,
...
OneGadget::Gadget.add(build_id, 743705,
...
OneGadget::Gadget.add(build_id, 744630,
