...
# https://gitlab.com/david942j/libcdb/blob/master/libc/libc0.1-i386-2.19-9/lib32/libc-2.19.so
# 
# Intel 80386
# 
...
OneGadget::Gadget.add(build_id, 658658,
...
OneGadget::Gadget.add(build_id, 658662,
...
OneGadget::Gadget.add(build_id, 658665,
...
OneGadget::Gadget.add(build_id, 659590,
