...
# https://gitlab.com/david942j/libcdb/blob/master/libc/libc6-i686-2.19-17/lib/i386-linux-gnu/i686/cmov/libc-2.19.so
# 
# Intel 80386
# 
...
# Compiled on a Linux 3.16.7 system on 2015-03-14.
...
OneGadget::Gadget.add(build_id, 741618,
...
OneGadget::Gadget.add(build_id, 741622,
...
OneGadget::Gadget.add(build_id, 741625,
...
OneGadget::Gadget.add(build_id, 742550,
...
OneGadget::Gadget.add(build_id, 1194726,
                      constraints: ["ebx is the GOT address of libc", "eax == NULL"],
                      effect: "execl(\"/bin/sh\", \"sh\", eax)")
OneGadget::Gadget.add(build_id, 1194730,
                      constraints: ["ebx is the GOT address of libc", "[esp+0x8] == NULL"],
                      effect: "execl(\"/bin/sh\", \"sh\", [esp+0x8])")
OneGadget::Gadget.add(build_id, 1194736,
                      constraints: ["ebx is the GOT address of libc", "eax == NULL"],
                      effect: "execl(\"/bin/sh\", eax)")
OneGadget::Gadget.add(build_id, 1194740,
                      constraints: ["ebx is the GOT address of libc", "[esp+0x4] == NULL"],
                      effect: "execl(\"/bin/sh\", [esp+0x4])")
