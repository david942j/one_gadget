...
# https://gitlab.com/david942j/libcdb/blob/master/libc/libc6-i686-2.19-4/lib/i386-linux-gnu/i686/cmov/libc-2.19.so
# 
# Intel 80386
# 
...
# Compiled on a Linux 3.14.5 system on 2014-06-23.
...
OneGadget::Gadget.add(build_id, 744162,
...
OneGadget::Gadget.add(build_id, 744169,
...
OneGadget::Gadget.add(build_id, 745094,
...
OneGadget::Gadget.add(build_id, 1197254,
                      constraints: ["ebx is the GOT address of libc", "eax == NULL"],
                      effect: "execl(\"/bin/sh\", \"sh\", eax)")
OneGadget::Gadget.add(build_id, 1197258,
                      constraints: ["ebx is the GOT address of libc", "[esp+0x8] == NULL"],
                      effect: "execl(\"/bin/sh\", \"sh\", [esp+0x8])")
OneGadget::Gadget.add(build_id, 1197264,
                      constraints: ["ebx is the GOT address of libc", "eax == NULL"],
                      effect: "execl(\"/bin/sh\", eax)")
OneGadget::Gadget.add(build_id, 1197268,
                      constraints: ["ebx is the GOT address of libc", "[esp+0x4] == NULL"],
                      effect: "execl(\"/bin/sh\", [esp+0x4])")
