...
# https://gitlab.com/david942j/libcdb/blob/master/libc/glibc-2.21-4-i686.pkg.tar/usr/lib/libc-2.21.so
# 
# Intel 80386
# 
...
OneGadget::Gadget.add(build_id, 402645,
                      constraints: ["ebx is the GOT address of libc", "[esp] == NULL"],
                      effect: "execl(\"/bin/sh\", [esp])")
OneGadget::Gadget.add(build_id, 1188051,
                      constraints: ["esi is the GOT address of libc", "eax == NULL"],
                      effect: "execl(\"/bin/sh\", eax)")
OneGadget::Gadget.add(build_id, 1188052,
