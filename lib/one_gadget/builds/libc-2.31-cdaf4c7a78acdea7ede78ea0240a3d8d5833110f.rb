...
# https://gitlab.com/david942j/libcdb/blob/master/libc/libc6-i386_2.31-0ubuntu10_amd64/lib32/libc-2.31.so
# 
# Intel 80386
# 
...
OneGadget::Gadget.add(build_id, 838363,
...
OneGadget::Gadget.add(build_id, 1335459,
                      constraints: ["ebp is the GOT address of libc", "eax == NULL"],
                      effect: "execl(\"/bin/sh\", eax)")
OneGadget::Gadget.add(build_id, 1335460,
