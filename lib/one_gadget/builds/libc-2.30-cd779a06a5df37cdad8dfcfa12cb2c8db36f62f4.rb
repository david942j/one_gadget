...
# https://gitlab.com/david942j/libcdb/blob/master/libc/libc6-i386_2.30-0ubuntu3_amd64/lib32/libc-2.30.so
# 
# Intel 80386
# 
...
OneGadget::Gadget.add(build_id, 833019,
...
OneGadget::Gadget.add(build_id, 1330963,
                      constraints: ["ebp is the GOT address of libc", "eax == NULL"],
                      effect: "execl(\"/bin/sh\", eax)")
OneGadget::Gadget.add(build_id, 1330964,
