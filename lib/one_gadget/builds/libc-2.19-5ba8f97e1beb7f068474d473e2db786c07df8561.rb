...
# https://gitlab.com/david942j/libcdb/blob/master/libc/libc6-i386-2.19-14/lib32/libc-2.19.so
# 
# Intel 80386
# 
...
# Compiled on a Linux 3.16.7 system on 2015-02-02.
...
OneGadget::Gadget.add(build_id, 744098,
...
OneGadget::Gadget.add(build_id, 744102,
...
OneGadget::Gadget.add(build_id, 744105,
...
OneGadget::Gadget.add(build_id, 745030,
...
OneGadget::Gadget.add(build_id, 1197190,
                      constraints: ["ebx is the GOT address of libc", "eax == NULL"],
                      effect: "execl(\"/bin/sh\", \"sh\", eax)")
OneGadget::Gadget.add(build_id, 1197194,
                      constraints: ["ebx is the GOT address of libc", "[esp+0x8] == NULL"],
                      effect: "execl(\"/bin/sh\", \"sh\", [esp+0x8])")
OneGadget::Gadget.add(build_id, 1197200,
                      constraints: ["ebx is the GOT address of libc", "eax == NULL"],
                      effect: "execl(\"/bin/sh\", eax)")
OneGadget::Gadget.add(build_id, 1197204,
                      constraints: ["ebx is the GOT address of libc", "[esp+0x4] == NULL"],
                      effect: "execl(\"/bin/sh\", [esp+0x4])")
