...
# https://gitlab.com/david942j/libcdb/blob/master/libc/libc6_2.26-0ubuntu2.1_arm64/lib/aarch64-linux-gnu/libc-2.26.so
# 
...
OneGadget::Gadget.add(build_id, 255552,
                      constraints: ["writable: x20+0x318", "x23 == NULL", "x3+0xcc0 == NULL || {x3+0xcc0, \"-c\", x25, NULL} is a valid argv"],
                      effect: "execve(\"/bin/sh\", sp+0x70, environ)")
...
OneGadget::Gadget.add(build_id, 255564,
                      constraints: ["writable: x19+0x4", "writable: x20+0x318", "x23 == NULL", "x3 == NULL || {x3, x0+0xcc8, x25, NULL} is a valid argv"],
                      effect: "execve(\"/bin/sh\", sp+0x70, environ)")
