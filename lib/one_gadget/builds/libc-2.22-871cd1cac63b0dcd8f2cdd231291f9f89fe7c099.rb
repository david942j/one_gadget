...
# https://gitlab.com/david942j/libcdb/blob/master/libc/libc6-i686-2.22-0experimental2/lib/i386-linux-gnu/i686/cmov/libc-2.22.so
# 
# Intel 80386
# 
...
OneGadget::Gadget.add(build_id, 399108,
                      constraints: ["ebx is the GOT address of libc", "[esp] == NULL"],
                      effect: "execl(\"/bin/sh\", [esp])")
OneGadget::Gadget.add(build_id, 1183580,
                      constraints: ["esi is the GOT address of libc", "eax == NULL"],
                      effect: "execl(\"/bin/sh\", eax)")
OneGadget::Gadget.add(build_id, 1183581,
