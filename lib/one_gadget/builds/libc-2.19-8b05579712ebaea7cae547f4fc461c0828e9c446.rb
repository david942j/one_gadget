...
# https://gitlab.com/david942j/libcdb/blob/master/libc/libc0.1-2.19-17/lib/i386-kfreebsd-gnu/libc-2.19.so
# 
# Intel 80386
# 
# GNU C Library (Debian GLIBC 2.19-17) stable release version 2.19, by Roland McGrath et al.
...
OneGadget::Gadget.add(build_id, 655106,
...
OneGadget::Gadget.add(build_id, 655110,
...
OneGadget::Gadget.add(build_id, 655113,
...
OneGadget::Gadget.add(build_id, 656038,
