...
# https://gitlab.com/david942j/libcdb/blob/master/libc/glibc-2.19-5-i686.pkg.tar/usr/lib/libc-2.19.so
# 
# Intel 80386
# 
...
# PARTICULAR PURPOSE.
# Compiled by GNU CC version 4.9.0 20140507 (prerelease).
# Compiled on a Linux 3.14.1 system on 2014-05-16.
...
OneGadget::Gadget.add(build_id, 241976,
...
OneGadget::Gadget.add(build_id, 242604,
                      ...
                      effect: "execve(\"/bin/sh\", esp+0x24, environ)")
OneGadget::Gadget.add(build_id, 242605,
...
OneGadget::Gadget.add(build_id, 242611,
                      ...
                      effect: "execve(\"/bin/sh\", esp+0x28, environ)")
OneGadget::Gadget.add(build_id, 242613,
...
OneGadget::Gadget.add(build_id, 242614,
...
OneGadget::Gadget.add(build_id, 242616,
...
OneGadget::Gadget.add(build_id, 242621,
                      ...
                      effect: "execve(\"/bin/sh\", esp+0x34, environ)")
OneGadget::Gadget.add(build_id, 242627,
                      ...
                      effect: "execve(\"/bin/sh\", esp+0x34, environ)")
OneGadget::Gadget.add(build_id, 242630,
                      constraints: ["ebx is the GOT address of libc", "[esp+0xc] == NULL", "eax == NULL", "[esp+0x28] == NULL || {[esp+0x28], [esp+0x2c], [esp+0x30], [esp+0x34], ...} is a valid argv"],
                      effect: "execve(\"/bin/sh\", esp+0x28, environ)")
OneGadget::Gadget.add(build_id, 242632,
                      constraints: ["ebx is the GOT address of libc", "[esp+0x10] == NULL", "[esp] == NULL", "eax == NULL", "[esp+0x2c] == NULL || {[esp+0x2c], [esp+0x30], [esp+0x34], [esp+0x38], ...} is a valid argv"],
                      effect: "execve(\"/bin/sh\", esp+0x2c, environ)")
OneGadget::Gadget.add(build_id, 242633,
                      constraints: ["ebx is the GOT address of libc", "[esp+0x14] == NULL", "[esp+0x4] == NULL", "[esp] == NULL", "[esp+0x30] == NULL || {[esp+0x30], [esp+0x34], [esp+0x38], [esp+0x3c], ...} is a valid argv"],
                      effect: "execve(\"/bin/sh\", esp+0x30, environ)")
OneGadget::Gadget.add(build_id, 242635,
                      constraints: ["ebx is the GOT address of libc", "[esp+0x18] == NULL", "[esp+0x4] == NULL", "[esp+0x8] == NULL", "[esp+0x34] == NULL || {[esp+0x34], [esp+0x38], [esp+0x3c], [esp+0x40], ...} is a valid argv"],
                      effect: "execve(\"/bin/sh\", esp+0x34, environ)")
OneGadget::Gadget.add(build_id, 242640,
                      constraints: ["ebx is the GOT address of libc", "[esp+0x18] == NULL", "[esp+0x34] == NULL || {[esp+0x34], [esp+0x38], [esp+0x3c], [esp+0x40], ...} is a valid argv"],
                      effect: "execve(\"/bin/sh\", esp+0x34, environ)")
...
OneGadget::Gadget.add(build_id, 242649,
                      ...
                      effect: "execve(\"/bin/sh\", esp+0x30, environ)")
OneGadget::Gadget.add(build_id, 242651,
...
OneGadget::Gadget.add(build_id, 242656,
                      ...
                      effect: "execve(\"/bin/sh\", esp+0x34, environ)")
OneGadget::Gadget.add(build_id, 242662,
...
OneGadget::Gadget.add(build_id, 242665,
...
OneGadget::Gadget.add(build_id, 242675,
                      constraints: ["ebx is the GOT address of libc", "[esp+0x28] == NULL || {[esp+0x28], [esp+0x2c], [esp+0x30], [esp+0x34], ...} is a valid argv", "[[eax]] == NULL || [eax] == NULL || [eax] is a valid envp"],
                      effect: "execve(\"/bin/sh\", esp+0x28, [eax])")
OneGadget::Gadget.add(build_id, 242685,
                      constraints: ["ebx is the GOT address of libc", "[esp+0x28] == NULL || {[esp+0x28], [esp+0x2c], [esp+0x30], [esp+0x34], ...} is a valid argv", "[[eax]] == NULL || [eax] == NULL || [eax] is a valid envp"],
                      effect: "execve(\"/bin/sh\", esp+0x28, [eax])")
OneGadget::Gadget.add(build_id, 242687,
...
OneGadget::Gadget.add(build_id, 412212,
                      constraints: ["ebx is the GOT address of libc", "eax == NULL"],
                      effect: "execl(\"/bin/sh\", \"sh\", eax)")
OneGadget::Gadget.add(build_id, 412215,
                      constraints: ["ebx is the GOT address of libc", "eax == NULL"],
                      effect: "execl(\"/bin/sh\", \"sh\", eax)")
OneGadget::Gadget.add(build_id, 412217,
                      constraints: ["ebx is the GOT address of libc", "eax == NULL"],
                      effect: "execl(\"/bin/sh\", \"sh\", eax)")
OneGadget::Gadget.add(build_id, 412221,
                      constraints: ["ebx is the GOT address of libc", "eax == NULL"],
                      effect: "execl(\"/bin/sh\", \"sh\", eax)")
OneGadget::Gadget.add(build_id, 412222,
                      constraints: ["ebx is the GOT address of libc", "[esp] == NULL"],
                      effect: "execl(\"/bin/sh\", \"sh\", [esp])")
OneGadget::Gadget.add(build_id, 412228,
                      constraints: ["ebx is the GOT address of libc", "eax == NULL"],
                      effect: "execl(\"/bin/sh\", eax)")
OneGadget::Gadget.add(build_id, 412229,
                      constraints: ["ebx is the GOT address of libc", "[esp] == NULL"],
                      effect: "execl(\"/bin/sh\", [esp])")
OneGadget::Gadget.add(build_id, 737738,
...
OneGadget::Gadget.add(build_id, 737742,
...
OneGadget::Gadget.add(build_id, 737745,
...
OneGadget::Gadget.add(build_id, 738354,
...
OneGadget::Gadget.add(build_id, 738358,
                      ...
                      effect: "execve(\"/bin/sh\", [ebp-0x28], [ebp+0x10])")
OneGadget::Gadget.add(build_id, 738361,
                      ...
                      effect: "execve(\"/bin/sh\", [ebp-0x28], [ebp+0x10])")
OneGadget::Gadget.add(build_id, 738364,
                      ...
                      effect: "execve(\"/bin/sh\", [ebp-0x28], [ebp+0x10])")
OneGadget::Gadget.add(build_id, 738367,
                      ...
                      effect: "execve(\"/bin/sh\", [ebp-0x28], [ebp+0x10])")
OneGadget::Gadget.add(build_id, 738453,
...
OneGadget::Gadget.add(build_id, 738456,
                      constraints: ["ebx is the GOT address of libc", "esi == 0x1", "writable: eax", "writable: ebp-0x1c", "[ebp+0x8] == NULL || {\"sh\", [ebp+0x8], [eax+0x8], [eax+0xc], ...} is a valid argv", "[[ebp+0x10]] == NULL || [ebp+0x10] == NULL || [ebp+0x10] is a valid envp"],
                      effect: "execve(\"/bin/sh\", eax, [ebp+0x10])")
OneGadget::Gadget.add(build_id, 738686,
                      ...
                      effect: "execve(\"/bin/sh\", [ebp-0x28], [ebp+0x10])")
OneGadget::Gadget.add(build_id, 738689,
                      constraints: ["ebx is the GOT address of libc", "[ebp-0x44] == 0x1", "writable: eax", "writable: ebp-0x3c", "[ebp-0x40] == NULL || {\"sh\", [ebp-0x40], [eax+0x8], [eax+0xc], ...} is a valid argv", "[[ebp+0x10]] == NULL || [ebp+0x10] == NULL || [ebp+0x10] is a valid envp"],
                      effect: "execve(\"/bin/sh\", [ebp-0x28], [ebp+0x10])")
OneGadget::Gadget.add(build_id, 738700,
                      ...
                      effect: "execve(\"/bin/sh\", [ebp-0x28], [ebp+0x10])")
OneGadget::Gadget.add(build_id, 738703,
                      ...
                      effect: "execve(\"/bin/sh\", [ebp-0x28], [ebp+0x10])")
OneGadget::Gadget.add(build_id, 738706,
                      ...
                      effect: "execve(\"/bin/sh\", [ebp-0x28], [ebp+0x10])")
OneGadget::Gadget.add(build_id, 738709,
                      constraints: ["ebx is the GOT address of libc", "edx == 0x1", "writable: [ebp-0x28]", "ecx == NULL || {\"sh\", ecx, [[ebp-0x28]+0x8], [[ebp-0x28]+0xc], ...} is a valid argv", "[[ebp+0x10]] == NULL || [ebp+0x10] == NULL || [ebp+0x10] is a valid envp"],
                      effect: "execve(\"/bin/sh\", [ebp-0x28], [ebp+0x10])")
OneGadget::Gadget.add(build_id, 1195813,
                      constraints: ["ebx is the GOT address of libc", "eax == NULL"],
                      effect: "execl(\"/bin/sh\", \"sh\", eax)")
OneGadget::Gadget.add(build_id, 1195816,
                      constraints: ["ebx is the GOT address of libc", "eax == NULL"],
                      effect: "execl(\"/bin/sh\", \"sh\", eax)")
OneGadget::Gadget.add(build_id, 1195818,
                      constraints: ["ebx is the GOT address of libc", "eax == NULL"],
                      effect: "execl(\"/bin/sh\", \"sh\", eax)")
OneGadget::Gadget.add(build_id, 1195822,
                      constraints: ["ebx is the GOT address of libc", "eax == NULL"],
                      effect: "execl(\"/bin/sh\", \"sh\", eax)")
OneGadget::Gadget.add(build_id, 1195823,
                      constraints: ["ebx is the GOT address of libc", "[esp] == NULL"],
                      effect: "execl(\"/bin/sh\", \"sh\", [esp])")
OneGadget::Gadget.add(build_id, 1195829,
                      constraints: ["ebx is the GOT address of libc", "eax == NULL"],
                      effect: "execl(\"/bin/sh\", eax)")
OneGadget::Gadget.add(build_id, 1195830,
                      constraints: ["ebx is the GOT address of libc", "[esp] == NULL"],
                      effect: "execl(\"/bin/sh\", [esp])")
